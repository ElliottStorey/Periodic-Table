...
export default function PeriodicTable() {
  function open_dialog(elName) {
    let index = elements.findIndex(x => x.name === elName);
    let symbol = elements[index].symbol;
    document.getElementById(symbol).style.textShadow = '4px 4px 4px #000';
    alert(`Information about ${elName}\n\nCategory | ${elements[index].category}\n\nDiscovered By | ${elements[index].discovered_by}\n\nPhase | ${elements[index].phase}\n\nAppearance | ${elements[index].appearance}\n\nSummary | ${elements[index].summary}`);
    document.getElementById(symbol).style.textShadow = '';
    let i = 0;
    while (i < 20 && elName === 'Gold') {
        let img = document.createElement('img');
        img.src = 'https://www.freeiconspng.com/thumbs/gold-bar-png/gold-bar-png-2.png';
        img.width = '200';
        img.height = '200';
    ...
    while (i < 20 && elName === 'Calcium') {
        let img = document.createElement('img');
        img.src = 'https://www.pngall.com/wp-content/uploads/5/Milk-Splash-PNG.png';
        img.width = '200';
        img.height = '200';
